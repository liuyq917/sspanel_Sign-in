...
class SspanelQd(object):
    def __init__(self):
        # 机场地址
        self.base_url = ['https://www.paofu.cloud','https://youyun777.net','https://sakura.kozow.com','https://www.paofu.cloud/','https://aco.monster']
        # 登录信息
        ...
        # 酷推qq推送（可空）
        self.ktkey = 'e83726bde9932cc5a526e81823879e37'
